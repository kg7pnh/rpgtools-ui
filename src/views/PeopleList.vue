  ...
  <div class="animated fadeIn">
    ...
    <b-modal id="item-model" scrollable v-model="showModal" :title="editModalTitle">
      <div class="form_input">
        <label for="input-none">Prefix</label>
        <b-input-group size="sm">
          <b-form-input
            ref="item_name_input"
            v-model="selectedItem.name_prefix"
            placeholder
            type="text"
          ></b-form-input>
        </b-input-group>
      ...
      <div class="form_input">
        ...
        <b-input-group size="sm">
          <b-form-input
            ref="item_name_input"
            v-model="selectedItem.name_first"
            placeholder
            type="text"
          ></b-form-input>
        </b-input-group>
      ...
      <div class="form_input">
        <label for="input-none">Middle Name</label>
        <b-input-group size="sm">
          <b-form-input
            ref="item_name_input"
            v-model="selectedItem.name_middle"
            placeholder
            type="text"
          ></b-form-input>
        </b-input-group>
      ...
      <div class="form_input">
        ...
        <b-input-group size="sm">
          <b-form-input
            ref="item_name_input"
            v-model="selectedItem.name_last"
            placeholder
            type="text"
          ></b-form-input>
        </b-input-group>
      ...
      <div class="form_input">
        <label for="input-none">Suffix</label>
        <b-input-group size="sm">
          <b-form-input
            ref="item_name_input"
            v-model="selectedItem.name_suffix"
            placeholder
            type="text"
          ></b-form-input>
        </b-input-group>
...
export default {
  ...
  computed: {
    ...
    itemCount: function() {
      return store.state.peopleCount;
    },
    user: function() {
  ...
  data() {
    return{
      sigurlarName: "person",
      singularNameCapitalized: "Person",
      pluralName: "people",
      pluralNameCapitalized: "People",
      addModalTitle: "Add Person",
      editModalTitle: "Edit Person",
      markdownInput: "",
      itemValid: false,
      currentPage: 1,
      selectedItem: {},
