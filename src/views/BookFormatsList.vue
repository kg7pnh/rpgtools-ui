...
export default {
  ...
  computed: {
    ...
    itemCount: function() {
      return store.state.bookFormatsCount
    },
    user: function() {
  ...
  data() {
    return{
      sigurlarName: "book format",
      singularNameCapitalized: "BookFormat",
      pluralName: "book formats",
      pluralNameCapitalized: "BookFormats",
      addModalTitle: "Add Book Format",
      editModalTitle: "Edit Book Format",
      markdownInput: "",
      itemValid: false,
      currentPage: 1,
      selectedItem: {},
