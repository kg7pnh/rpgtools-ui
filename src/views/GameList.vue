<template>
  <div class="animated fadeIn">
    ...
    <b-modal id="item-model" scrollable v-model="showModal" :title="editModalTitle">
      ...
      <div class="form_input">
        <label for="input-none">Game System</label>
        <b-input-group size="sm">
          <b-form-select id="item-game-system" v-model="selectedGameSystem" :options="gameSystems"></b-form-select>
        </b-input-group>
      </div>
...
export default {
  ...
  data() {
    return{
      sigurlarName: "game",
      singularNameCapitalized: "Game",
      pluralName: "games",
      pluralNameCapitalized: "Games",
      addModalTitle: "Add Game",
  ...
  methods: {
    ...
    putItem() {
      ...
      this.selectedItem.game_system = this.selectedGameSystem;
      this.$store.dispatch({
    ...
    editItem(item) {
      ...
      this.selectedGameSystem = item.game_system;
